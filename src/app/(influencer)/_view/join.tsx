      ...
      <div className='mx-[72px] flex max-w-[648px] justify-between'>
        <div className='flex flex-col items-center justify-center gap-[22px]'>
          ...
          <div className='flex gap-[10px]'>
            <button
              type='button'
              className='flex h-[42px] w-[clamp(100px,10vw,121px)] items-center justify-center gap-[5px] rounded-[28px] bg-primaryColor text-[0.875rem] font-semibold tracking-[-5%] text-[#fff] hover:bg-[#3ECCCC] hover:shadow-qrBoxShadow'
            >
              <svg
