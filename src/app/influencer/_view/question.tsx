  ...
  return (
    <section className='flex justify-center'>
      <div className='flex flex-col px-[100px] pb-[120px] pt-[90px]'>
        ...
        <ul className='flex w-[1240px] flex-col gap-6'>
          {questionContent.map((q) => {
            return (
              <li
                key={q.index}
                className='flex flex-col gap-6 rounded-[32px] bg-cardGray px-[38px] py-6'
              >
                <div className='flex items-center justify-between'>
                  <h3 className='text-[1.75rem] font-medium leading-[2.625rem] tracking-[-5%] text-mainText'>
                    {q.question}
                  </h3>
                  <svg
                    width='48'
                ...
                <p className='text-[1.75rem] font-medium leading-[2.625rem] tracking-[-5%] text-[#757575]'>
                  {q.answer}
                </p>
              </li>
            );
