        ...
        <div className='flex flex-col gap-y-3'>
          ...
          <InfluencerCard style='bg-cardMint'>
            <div className='relative flex'>
              <div className='flex h-[227px] flex-col gap-[17.5px] pl-[clamp(20px,4vw,40px)] text-mainText'>
                <h1 className='pt-[49.5px] text-[clamp(16px,4vw,24px)] font-bold'>
                  체험 선정 여부 96시간 이내
                </h1>
                <p className='relative z-10 text-[clamp(14px,3vw,18px)] font-normal tracking-[-0.0875rem]'>
          ...
          <InfluencerCard style='bg-cardGray'>
            <div className='relative flex'>
              <div className='flex h-[392px] flex-col gap-[25px] pl-[clamp(20px,4vw,40px)] text-mainText'>
                <h1 className='pt-[54px] text-[clamp(16px,4vw,24px)] font-bold'>
                  와이리가 인증하는 영향력 <br />
                  등급을 받아보세요
                </h1>
                <div className='flex flex-col gap-[10px]'>
                  <p className='text-text-[clamp(14px,3vw,18px)] z-10 font-normal tracking-[-0.0875rem]'>
                    와이리는 채널에 따라 예상 영향력에 따라서 등급을 부여하고
                    있습니다. <br />
                    와이리에서 인증하는 인플루언서가 되어보세요.
                  </p>
                  <span className='text-[clamp(12px,2vw,14px)] font-light text-thirdText'>
                    *채널 승급은 매월말에 신청을 받고 있습니다.
                  </span>
                </div>
              </div>
              <div className='absolute bottom-0 left-[50%] translate-x-[-50%]'>
                <div className='flex items-end justify-center gap-[31.95px]'>
                  <Image
                    src={silver}
                    alt='실버'
                    className='w-[clamp(93.5px,5vw,187px)]'
                  />
                  <Image
                    src={gold}
                    alt='골드'
