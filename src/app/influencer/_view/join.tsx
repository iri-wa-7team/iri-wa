...
export default function Join() {
  return (
    ...
    >
      <div className='mx-[10%] flex max-w-[576px] justify-center gap-[11.28%]'>
        <div className='flex flex-col items-center justify-center gap-[22px] pl-[4.2%]'>
          <h1 className='text-[1.5rem] font-bold leading-[31.68px] tracking-[-5%] text-mainText'>
            와이리 가입하기
          </h1>
          <div className='flex gap-[1.7%]'>
            <button
              type='button'
              className='flex h-[42px] w-[121px] max-w-[121px] items-center justify-center gap-[5px] rounded-[28px] bg-primaryColor text-[0.875rem] font-semibold tracking-[-2.5%] text-[#fff] hover:bg-[#3ECCCC] hover:shadow-qrBoxShadow'
            >
              <svg
                width='31'
                height='30'
            ...
            <button
              type='button'
              className='flex h-[42px] w-[121px] items-center justify-center gap-[5px] rounded-[28px] bg-primaryColor text-[0.875rem] font-semibold tracking-[-5%] text-[#fff] hover:bg-[#3ECCCC] hover:shadow-qrBoxShadow'
            >
              <svg
                width='31'
                height='30'
